------------------------------------------------------------------------------------
--- PROJECT SILVERSCREEN: SNOWFLAKE SETUP AND DATA INGESTION version 1.0 -----------
--- runs in snowflake, not dbt. requires raw data on stage -------------------------
------------------------------------------------------------------------------------


-- setting up the datatype format for importing the staged csv files
...
select * from SILVERSCREEN.RAW.MOVIESSILVERSCREEN.RAW.SALES_CINEMA_01