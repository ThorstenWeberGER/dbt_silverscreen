...
> **For Recruiters:** End-to-end dbt + Snowflake ETL pipeline — medallion architecture, automated testing, and a Tableau dashboard that surfaced a real business problem from messy raw data.
